 <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="col-xs-6 col-sm-6 huge-placeholder">
            ...
            <h2 class="sub-header">搜索教师</h2>

          </div>

            <div class="col-xs-6 col-sm-6 huge-placeholder">
                <div class="ui right floated transparent-seg segment">
                    <form class="ui form" action="<?php echo site_url('ims/ims_search_teacher/search')?>" method="post">
                        <div class="ui left labeled icon input">
                            <div class="ui teal dropdown label">
                                ...
                                <div class="menu">
                                    <div class="item" data-value="uid">工号</div>
            ...
            <table class="ui striped table">
                ...
                <tr>
                    <form class="ui form" action="<?php echo site_url('ims/ims_add_teacher') . "/" . "index/" . $item['uid'] . '/1'?>" method="post">
...
?></td>
            ...
            <?php endif;?>
                ...
                <br>
                <form action="<?php echo site_url('ims/ims_add_teacher')?>" method="post">
                <button class="ui right floated primary labeled icon button" type="submit">
                    <i class="user icon"></i> 添加老师
                </button>
                </form>
        </div>
      </div>
